...
def send_reminder_email():
	# read user email setting
	read_Email_Settings()

	#set the email ID where you want to send the test email 
	To_Email_ID = "yoursmarttrashcan@gmai.com"


	# Send Plain Text Email 
	email = Class_eMail()
	email.send_Text_Mail("jfs9@cornell.edu", 'Trash Can full reminder', 'Your trash can is full please take time to empty it.')
	del email
